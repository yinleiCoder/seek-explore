  ...
  return (
    <main className="grid p-2 md:p-5 grid-cols-12 gap-y-5">
      ...
      <article
       ...
       prose-video:aspect-video prose-strong:text-indigo-500 prose-table:border prose-thread:!rounded-md prose-thead:bg-indigo-700 hover:prose-tr:bg-indigo-300 dark:hover:prose-tr:bg-indigo-400 dark:prose-thead:bg-zinc-800 prose-thead:rounded-md prose-th:text-white prose-blockquote:border prose-blockquote:border-black prose-blockquote:shadow-md prose-blockquote:shadow-black/50 dark:prose-blockquote:border-gray-300 dark:prose-blockquote:shadow-md dark:prose-blockquote:shadow-indigo-500/50 prose-blockquote:rounded-lg prose-blockquote:px-3 max-w-none col-start-1 col-end-13 md:col-start-2 md:col-end-12 lg:col-start-3 lg:col-end-11"
      >
