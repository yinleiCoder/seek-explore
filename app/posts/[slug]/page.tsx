...
export default function PostPage({
  ...
  return (
    <main className="grid p-2 md:p-0 grid-cols-12 container mx-auto gap-y-2 xl:px-2">
      <div className="col-start-1 col-end-13 md:col-start-2 md:col-end-12 lg:col-start-1 lg:col-end-10 flex gap-3 items-center">
        <Link href={'/me'}>
          <Image
      ...
      <div className="col-start-1 col-end-13 md:col-start-2 md:col-end-12 lg:col-start-1 lg:col-end-10 flex flex-col items-start gap-1">
      ...
      <div className="hidden w-full lg:block lg:col-start-10 lg:col-end-13 lg:row-start-1 relative lg:row-span-5 lg:pl-8">
        <details
